...
class Call
{
    ...
    protected $resolvedTypes = array();

    protected $resolvedDynamicTypes = array();

    protected $temporalVariables = array();

    protected $mustCheckForCopy = array();
